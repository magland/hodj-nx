...
const TimeSelectionBar: FunctionComponent<Props> = ({width, height, hideVisibleTimeRange}) => {
    const {currentTimeSec, setCurrentTime, startTimeSec, endTimeSec, visibleStartTimeSec, visibleEndTimeSec, setVisibleTimeRange} = useTimeSelection()
    ...
    }, [isDragging, pixelToFrac, startTimeSec, endTimeSec, setCurrentTime, visibleStartTimeSec, visibleEndTimeSec, setVisibleTimeRange])
    ...
    const handleDragStop = useCallback((evt: DraggableEvent, ui: DraggableData) => {
        ...
        setIsDragging(false)
    }, [setCurrentTime, fracToPixel, startTimeSec, endTimeSec, pixelToFrac, visibleStartTimeSec, visibleEndTimeSec, setVisibleTimeRange, currentTimeSec])
